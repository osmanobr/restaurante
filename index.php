...
<head>
    ...
    <title>Restaurante Bot - Sistema de Vendas</title>
...
<body>
                ...
                <div class="chat-container">
                    ...
                    <div class="chat-header bg-primary text-white p-3 d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="mb-0">Carregando...</h5>
                            <small class="text-light">Aguarde...</small>
                        </div>
                    ...
                    <!-- Quick Actions -->
                    <div class="chat-footer bg-light p-3 border-top">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button class="btn btn-outline-success btn-sm" id="cartFooterButton" style="display: none;">
                                🛒 Carrinho (<span id="cartFooterCount">0</span>)
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modal de cadastro de cliente (modificado para incluir senha) -->
          ...
          <div class="modal-body">
            <form id="customerForm">
              <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="customerPhone" placeholder="Apenas números (DDD + número)" required>
                <div class="form-text">Digite seu celular com DDD (apenas números)</div>
              </div>
              <div class="mb-3">
          ...
          <div class="modal-body">
            <form id="loginForm">
              <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="loginPhone" placeholder="Apenas números (DDD + número)" required>
              </div>
              <div class="mb-3">
